...
string FindCell(double(*),int,double,double,double);
int CheckFate(string,int);
double CalcR(string,double,int**);
int CalcFate(int&,double&,double&,double(*),double,int,int**);
