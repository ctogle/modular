...
void CellDifference(string,string,int&,int&);
void MoveNeutronLRUD(double(*),double,double,int,int,int,int,int,int,int);
void MoveNeutronAll(double(*),double,double,int,int,int,int,int,int,int);
int BoundCheck(double(*),double,double,double,int,string,string);
