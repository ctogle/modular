...
dizzyData = np.genfromtxt('models/acidTest7_dizzy.csv', delimiter=',')
plt.plot(dizzyData[:,0], dizzyData[:,1], 'r')
plt.plot(dizzyData[:,0], dizzyData[:,2], 'r')

plt.savefig('acidTest7_compare.pdf')
...
plt.savefig('acidTest7_error.pdf')
