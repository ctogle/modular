...
#import modular_core.modules.particles_support.generic_wrap as wrapper
...
lgd = lqg.lgd
lgb = lqg.lgb
import modular_core.<program_name>.lib<base_class_module> as lprog
...
if __name__ == 'modular_developer.libcodegenerator':
	if lfu.gui_pack is None: lfu.find_gui_pack()
	lgm = lfu.gui_pack.lgm
	lgd = lfu.gui_pack.lgd
	lgb = lfu.gui_pack.lgb
